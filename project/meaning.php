  ...
  <div class="container">
    <div class="navbar-header">
	  ...
	  <ul class="dropdown-menu" role="menu">
            <li class="active"><a href="meaning.php">Search by Meaning</a></li>
...
<center>
<div id="innercont">
<h1> Search for Kanji by the Meaning </h1>
<h3> If you know the meaning of a Kanji, then type it in and find it! </h3>
<!--****************************************************************************************************************************************************************-->
<form action="meaning.php" method="post">
...
<?php
   if(isset($_POST['keyword']))
   {
      $result=mysqli_query($con,"SELECT kanji, grade_level, sc, readings, meanings
                                 FROM kanjiinfo
                                 WHERE meanings LIKE '%$keyword%'
				 order by case when meanings LIKE '$keyword' then 1
					       when meanings LIKE '$keyword,%' then 2
					       when meanings LIKE '% $keyword,%' then 3
					       when meanings LIKE '%$keyword%' then 4 end");
      if($result)
      {
